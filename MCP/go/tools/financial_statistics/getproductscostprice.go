...
func GetproductscostpriceHandler(cfg *config.APIConfig) func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
	return func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
		...
		url := fmt.Sprintf("%s/financial_statistics/productsCostPrice%s", cfg.BaseURL, queryString)
...
func CreateGetproductscostpriceTool(cfg *config.APIConfig) models.Tool {
	tool := mcp.NewTool("get_financial_statistics_productsCostPrice",
		mcp.WithDescription("Get products cost price"),
	...
	return models.Tool{
		Definition: tool,
		Handler:    GetproductscostpriceHandler(cfg),
	}
}
