...
func GetinvoicedamountHandler(cfg *config.APIConfig) func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
	return func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
		...
		url := fmt.Sprintf("%s/financial_statistics/invoicedAmount%s", cfg.BaseURL, queryString)
...
func CreateGetinvoicedamountTool(cfg *config.APIConfig) models.Tool {
	tool := mcp.NewTool("get_financial_statistics_invoicedAmount",
		mcp.WithDescription("Get invoiced amount"),
	...
	return models.Tool{
		Definition: tool,
		Handler:    GetinvoicedamountHandler(cfg),
	}
}
