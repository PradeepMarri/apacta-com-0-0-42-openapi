...
func GetexpensessalespriceHandler(cfg *config.APIConfig) func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
	return func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
		...
		url := fmt.Sprintf("%s/financial_statistics/expensesSalesPrice%s", cfg.BaseURL, queryString)
...
func CreateGetexpensessalespriceTool(cfg *config.APIConfig) models.Tool {
	tool := mcp.NewTool("get_financial_statistics_expensesSalesPrice",
		mcp.WithDescription("Get expenses sales price"),
	...
	return models.Tool{
		Definition: tool,
		Handler:    GetexpensessalespriceHandler(cfg),
	}
}
