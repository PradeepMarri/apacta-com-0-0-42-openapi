...
func GetfinancialstatisticsoverviewHandler(cfg *config.APIConfig) func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
	return func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
		...
		url := fmt.Sprintf("%s/financial_statistics/overview%s", cfg.BaseURL, queryString)
...
func CreateGetfinancialstatisticsoverviewTool(cfg *config.APIConfig) models.Tool {
	tool := mcp.NewTool("get_financial_statistics_overview",
		mcp.WithDescription("Get statistics overview"),
	...
	return models.Tool{
		Definition: tool,
		Handler:    GetfinancialstatisticsoverviewHandler(cfg),
	}
}
