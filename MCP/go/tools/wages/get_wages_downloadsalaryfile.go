...
func Get_wages_downloadsalaryfileHandler(cfg *config.APIConfig) func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
	return func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
		...
		url := fmt.Sprintf("%s/wages/downloadSalaryFile%s", cfg.BaseURL, queryString)
...
func CreateGet_wages_downloadsalaryfileTool(cfg *config.APIConfig) models.Tool {
	tool := mcp.NewTool("get_wages_downloadSalaryFile",
		mcp.WithDescription("Download salary file"),
	...
	return models.Tool{
		Definition: tool,
		Handler:    Get_wages_downloadsalaryfileHandler(cfg),
	}
}
