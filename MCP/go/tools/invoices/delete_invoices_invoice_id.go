...
func Delete_invoices_invoice_idHandler(cfg *config.APIConfig) func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
...
func CreateDelete_invoices_invoice_idTool(cfg *config.APIConfig) models.Tool {
	tool := mcp.NewTool("delete_invoices_invoice_id",
	...
	return models.Tool{
		Definition: tool,
		Handler:    Delete_invoices_invoice_idHandler(cfg),
	}
}
