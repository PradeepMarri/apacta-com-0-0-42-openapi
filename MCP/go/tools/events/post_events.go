...
func Post_eventsHandler(cfg *config.APIConfig) func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
	return func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
		...
		url := fmt.Sprintf("%s/events", cfg.BaseURL)
...
func CreatePost_eventsTool(cfg *config.APIConfig) models.Tool {
	tool := mcp.NewTool("post_events",
		mcp.WithDescription("Create event"),
	...
	return models.Tool{
		Definition: tool,
		Handler:    Post_eventsHandler(cfg),
	}
}
