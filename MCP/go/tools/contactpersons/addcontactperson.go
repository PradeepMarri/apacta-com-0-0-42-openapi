...
func AddcontactpersonHandler(cfg *config.APIConfig) func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
	return func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
		...
		url := fmt.Sprintf("%s/contacts/%s/contact_persons", cfg.BaseURL, contact_id)
...
func CreateAddcontactpersonTool(cfg *config.APIConfig) models.Tool {
	tool := mcp.NewTool("post_contacts_contact_id_contact_persons",
		mcp.WithDescription("Add a new contact person to a contact"),
	...
	return models.Tool{
		Definition: tool,
		Handler:    AddcontactpersonHandler(cfg),
	}
}
