...
func Get_projects_project_id_users_user_idHandler(cfg *config.APIConfig) func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
	return func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
		...
		url := fmt.Sprintf("%s/projects/%s/users/%s", cfg.BaseURL, user_id, project_id)
...
func CreateGet_projects_project_id_users_user_idTool(cfg *config.APIConfig) models.Tool {
	tool := mcp.NewTool("get_projects_project_id_users_user_id",
		mcp.WithDescription("View specific user assigned to project"),
	...
	return models.Tool{
		Definition: tool,
		Handler:    Get_projects_project_id_users_user_idHandler(cfg),
	}
}
