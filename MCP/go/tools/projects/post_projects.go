...
func Post_projectsHandler(cfg *config.APIConfig) func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
...
func CreatePost_projectsTool(cfg *config.APIConfig) models.Tool {
	tool := mcp.NewTool("post_projects",
		mcp.WithDescription("Add a project"),
		...
		mcp.WithArray("child_projects", mcp.Description("")),
	...
	return models.Tool{
		Definition: tool,
		Handler:    Post_projectsHandler(cfg),
	}
}
