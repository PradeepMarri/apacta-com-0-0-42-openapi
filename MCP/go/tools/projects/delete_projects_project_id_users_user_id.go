...
func Delete_projects_project_id_users_user_idHandler(cfg *config.APIConfig) func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
...
func CreateDelete_projects_project_id_users_user_idTool(cfg *config.APIConfig) models.Tool {
	tool := mcp.NewTool("delete_projects_project_id_users_user_id",
		mcp.WithDescription("Delete user from project"),
	...
	return models.Tool{
		Definition: tool,
		Handler:    Delete_projects_project_id_users_user_idHandler(cfg),
	}
}
