...
func Delete_contacts_contact_idHandler(cfg *config.APIConfig) func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
...
func CreateDelete_contacts_contact_idTool(cfg *config.APIConfig) models.Tool {
	tool := mcp.NewTool("delete_contacts_contact_id",
	...
	return models.Tool{
		Definition: tool,
		Handler:    Delete_contacts_contact_idHandler(cfg),
	}
}
