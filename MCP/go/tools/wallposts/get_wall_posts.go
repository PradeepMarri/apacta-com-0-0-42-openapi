...
func Get_wall_postsHandler(cfg *config.APIConfig) func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
	return func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
		...
		url := fmt.Sprintf("%s/wall_posts%s", cfg.BaseURL, queryString)
...
func CreateGet_wall_postsTool(cfg *config.APIConfig) models.Tool {
	tool := mcp.NewTool("get_wall_posts",
		mcp.WithDescription("View list of wall posts"),
	...
	return models.Tool{
		Definition: tool,
		Handler:    Get_wall_postsHandler(cfg),
	}
}
