...
func Put_companies_company_id_integration_settings_companies_integration_setting_idHandler(cfg *config.APIConfig) func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
...
func CreatePut_companies_company_id_integration_settings_companies_integration_setting_idTool(cfg *config.APIConfig) models.Tool {
	tool := mcp.NewTool("put_companies_company_id_integration_settings_companies_integration_setting_id",
		mcp.WithDescription("Edit a company integration setting"),
	...
	return models.Tool{
		Definition: tool,
		Handler:    Put_companies_company_id_integration_settings_companies_integration_setting_idHandler(cfg),
	}
}
