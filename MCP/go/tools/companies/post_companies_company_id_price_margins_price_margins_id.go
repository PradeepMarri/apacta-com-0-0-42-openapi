...
func Post_companies_company_id_price_margins_price_margins_idHandler(cfg *config.APIConfig) func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
...
func CreatePost_companies_company_id_price_margins_price_margins_idTool(cfg *config.APIConfig) models.Tool {
	tool := mcp.NewTool("post_companies_company_id_price_margins_price_margins_id",
		mcp.WithDescription("Add a company price margin"),
	...
	return models.Tool{
		Definition: tool,
		Handler:    Post_companies_company_id_price_margins_price_margins_idHandler(cfg),
	}
}
