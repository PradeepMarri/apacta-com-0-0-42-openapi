...
func Get_companies_company_id_integration_settings_companies_integration_setting_idHandler(cfg *config.APIConfig) func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
...
func CreateGet_companies_company_id_integration_settings_companies_integration_setting_idTool(cfg *config.APIConfig) models.Tool {
	tool := mcp.NewTool("get_companies_company_id_integration_settings_companies_integration_setting_id",
		mcp.WithDescription("Get a company integration setting"),
	...
	return models.Tool{
		Definition: tool,
		Handler:    Get_companies_company_id_integration_settings_companies_integration_setting_idHandler(cfg),
	}
}
