...
func Get_companies_company_id_companies_integration_feature_settings_c_integration_feature_setting_idHandler(cfg *config.APIConfig) func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
...
func CreateGet_companies_company_id_companies_integration_feature_settings_c_integration_feature_setting_idTool(cfg *config.APIConfig) models.Tool {
	tool := mcp.NewTool("get_companies_company_id_companies_integration_feature_settings_c_integration_feature_setting_id",
		mcp.WithDescription("View a company integration feature setting"),
	...
	return models.Tool{
		Definition: tool,
		Handler:    Get_companies_company_id_companies_integration_feature_settings_c_integration_feature_setting_idHandler(cfg),
	}
}
