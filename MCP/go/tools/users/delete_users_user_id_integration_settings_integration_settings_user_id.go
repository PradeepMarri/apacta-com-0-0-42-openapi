...
func Delete_users_user_id_integration_settings_integration_settings_user_idHandler(cfg *config.APIConfig) func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
...
func CreateDelete_users_user_id_integration_settings_integration_settings_user_idTool(cfg *config.APIConfig) models.Tool {
	tool := mcp.NewTool("delete_users_user_id_integration_settings_integration_settings_user_id",
		mcp.WithDescription("Delete a user integration setting"),
	...
	return models.Tool{
		Definition: tool,
		Handler:    Delete_users_user_id_integration_settings_integration_settings_user_idHandler(cfg),
	}
}
