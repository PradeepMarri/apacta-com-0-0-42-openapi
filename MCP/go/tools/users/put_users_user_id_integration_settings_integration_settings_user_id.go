...
func Put_users_user_id_integration_settings_integration_settings_user_idHandler(cfg *config.APIConfig) func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
...
func CreatePut_users_user_id_integration_settings_integration_settings_user_idTool(cfg *config.APIConfig) models.Tool {
	tool := mcp.NewTool("put_users_user_id_integration_settings_integration_settings_user_id",
		mcp.WithDescription("Edit a user integration setting"),
	...
	return models.Tool{
		Definition: tool,
		Handler:    Put_users_user_id_integration_settings_integration_settings_user_idHandler(cfg),
	}
}
