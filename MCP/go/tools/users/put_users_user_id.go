...
func Put_users_user_idHandler(cfg *config.APIConfig) func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
...
func CreatePut_users_user_idTool(cfg *config.APIConfig) models.Tool {
	tool := mcp.NewTool("put_users_user_id",
	...
	return models.Tool{
		Definition: tool,
		Handler:    Put_users_user_idHandler(cfg),
	}
}
