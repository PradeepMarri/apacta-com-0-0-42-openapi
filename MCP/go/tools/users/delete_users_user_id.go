...
func Delete_users_user_idHandler(cfg *config.APIConfig) func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
...
func CreateDelete_users_user_idTool(cfg *config.APIConfig) models.Tool {
	tool := mcp.NewTool("delete_users_user_id",
	...
	return models.Tool{
		Definition: tool,
		Handler:    Delete_users_user_idHandler(cfg),
	}
}
